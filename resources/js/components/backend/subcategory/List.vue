                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr v-for="(subcategory,index) in subcategories">
                                    <td>{{index+1}}</td>
                                    <td v-if="subcategory.category">{{subcategory.category.cat_name}}</td>
                                    <td>{{subcategory.title}}</td>
                                    <td>
                                        <router-link :to="`edit-post/${subcategory.id}`">Edit</router-link>
                                        <a href="" @click.prevent = "deletePost(subcategory.id)" >Delete</a>
